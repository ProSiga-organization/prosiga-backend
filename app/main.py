...
# Adiciona o Middleware com suporte a preview deployments da Vercel e localhost
app.add_middleware(
    CORSMiddleware,
    allow_origin_regex=r"https://.*\.vercel\.app|http://localhost:\d+|http://127\.0\.0\.1:\d+|http://0\.0\.0\.0:\d+",
